...
module.exports = {
  async handleMessage(message, args) {
    ...
    try {
      ...
      const result = await model.thanosServer(guildId);
      ...
      const successMessage = langManager.getString(
        ...
        "thanos_success",
        {
          playersRemoved: result.playersRemoved.toLocaleString(),
          usersUpdated: result.usersUpdated.toLocaleString(),
          playersStatsReset: result.playersStatsReset.toLocaleString(),
      ...
      console.error("❌ Error en ThanosCommand:", error);
      const errorMessage = langManager.getString(
        guildId,
        "thanos_error",
        {},
