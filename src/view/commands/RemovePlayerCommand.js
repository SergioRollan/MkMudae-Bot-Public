...
module.exports = {
  async handleMessage(message, args) {
    ...
    try {
      ...
      const removeResult = await model.removePlayerFromUser(
        targetDiscordId,
      ...
      if (!removeResult.success) {
        ...
        switch (removeResult.error) {
          ...
          case "not_in_roster":
            errorKey = "removeplayer_player_not_owned";
            params = { name: playerIdentifier };
            break;
          case "user_not_found":
            errorKey = "removeplayer_user_not_found";
            break;
          case "remove_failed":
            errorKey = "removeplayer_remove_failed";
            break;
          default:
            break;
        }
      ...
      console.error("❌ Error en RemovePlayerCommand:", error);
      const errorMessage = langManager.getString(
        guildId,
