  ...
  async handleMessage(message, args) {
    ...
    if (amount > 0) {
      ...
      try {
        ...
        console.error("❌ Error verificando coins para war:", err);
        const errorMessage = langManager.getString(
          guildId,
          "war_error_unknown",
          {},
    ...
    if (!result.success) {
      ...
      switch (result.error) {
        case "invalid_users":
          ...
          break;
        case "self_request":
          errorKey = "war_error_self";
          break;
        case "invalid_amount":
          errorKey = "war_error_invalid_amount";
          break;
        case "already_pending":
          errorKey = "war_error_already_pending";
          break;
        default:
          break;
      }
    ...
    const timeoutId = setTimeout(async () => {
      ...
      try {
        ...
        console.error("❌ Error enviando mensaje de timeout de war:", err);
      }
    }, 30000);
